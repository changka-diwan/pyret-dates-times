...
(provide A N EN RN No B S EQ RA TA Ar RA-of A-of L L-of O-of S-of E-of P-of D TU DoW MoY ZO ZI)
...
(define D (a-id "Duration" (xref "<global>" "Duration")))
(define TU (a-id "TemporalUnit" (xref "<global>" "TemporalUnit")))
(define DoW (a-id "DayOfWeek" (xref "<global>" "DayOfWeek")))
(define MoY (a-id "MonthOfYear" (xref "<global>" "MonthOfYear")))
(define ZO (a-id "ZoneOffset" (xref "<global>" "ZoneOffset")))
(define ZI (a-id "ZoneId" (xref "<global>" "ZoneId")))
